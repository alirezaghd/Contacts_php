...
$lists = mysqli_query($connection, "SELECT * FROM specs");
...
<body>
    ...
    <div class="container">
        ...
        <div class="row ">
            ...
            <div class="col-2 mt-3">
                <form action="del_contants.php" method="post">
                    <button type="submit"  name="btn_del" id="btn_delete" class="btn btn-danger ">پاک کردن  <i class="fas fa-trash"></i></button>
                </form>
            </div>
                                                ...
                                                <div class="modal-body">
                                                    <div class="card d-flex flex-column align-items-center" id="exampleModal1">
                                                        ...
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item border-0"><i class="fas fa-at"></i> ایمیل :<?php echo $list["email"];  ?></li>
                                                            <li class="list-group-item border-0"><i class="fas fa-phone"></i> موبایل :<?php echo $list["mobile"];  ?></li>
                                                            <li class="list-group-item border-0"><i class="fas fa-birthday-cake"></i> تاریخ تولد : <?php echo $list["birthday"];  ?></li>
                                                        </ul>
